...
export default function DropzoneComponent({
  ...
  const handleDrop = useCallback(
    ...
    [files, maxFiles, multiple, onDrop]
  );
    ...
    <div className="transition border border-gray-300 border-dashed cursor-pointer rounded-xl hover:border-brand-500 dark:border-gray-700">
      ...
      >
        ...
        <div className="flex flex-col items-center">
          <div className="mb-4 flex h-[68px] w-[68px] items-center justify-center rounded-full bg-gray-200 text-gray-700 dark:bg-gray-800 dark:text-gray-400">
            <svg
          ...
          <p className="text-center mb-4 text-sm text-gray-700 dark:text-gray-400">
